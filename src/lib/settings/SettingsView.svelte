<script lang="ts">
  ...
  import { applyTheme, getSettings, openLogDir, openRepository, previewTheme, updateSettings, type LanguagePreference, type Settings, type Theme } from "./api";
